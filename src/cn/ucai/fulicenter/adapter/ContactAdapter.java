...
public class ContactAdapter extends ArrayAdapter<UserBean>  implements SectionIndexer{
	...
	public ContactAdapter(Context context, int resource, ArrayList<UserBean> mContactList) {
		super(context, resource, mContactList);
        mContext = context;
        this.res = resource;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(username.equals(Constant.NEW_FRIENDS_USERNAME)){
			...
			int unreadMsgCount = ((DemoHXSDKHelper) HXSDKHelper.getInstance()).getContactList().get(Constant.NEW_FRIENDS_USERNAME).getUnreadMsgCount();
...
//			    holder.unreadMsgView.setText(user.getUnreadMsgCount()+"");
	...
	private class  MyFilter extends Filter{
        List<UserBean> mOriginalList = null;
		
		public MyFilter(List<UserBean> myList) {
